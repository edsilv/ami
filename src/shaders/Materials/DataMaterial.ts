...
// tslint:disable-next-line: no-var-requires
const fragmentSourceIdn = require('raw-loader!glslify-loader!../webgl/data/data_idnInterp.frag')
  .default;
// tslint:disable-next-line: no-var-requires
const fragmentSourceTri = require('raw-loader!glslify-loader!../webgl/data/data_triInterp.frag')
  .default;
