...
export default class BaseLoader extends EventEmitter {
                 ...
                 constructor(
                   container: any = null,
                   ProgressBar: any = HelpersProgressBar
                 ) {
                   super();
                   this._loaded = -1;
                   this._totalLoaded = -1;
                  ...
                  */
                 public fetch(url: any, requests: any) {
                  ...
                  * @return {promise} promise.
                  */
                 public loadSequenceGroup(url: any, requests: any) {
                   const fetchSequence = [];
                  ...
                  * @return {promise} promise.
                  */
                 public loadSequence(url: any, requests: any) {
                  ...
                  * @return {promise} promise
                  */
                 public load(url: any, requests: any) {
