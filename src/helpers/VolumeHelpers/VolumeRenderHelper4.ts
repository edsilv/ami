...
import { VolumeMaterial, Volume4Material } from '../../shaders';
...
export class VolumeRenderHelper4 extends BaseTHREEHelper {
  ...
  private _unpackedTextures = [];
  private _unpackingTargets = [];
  //#endregion
  ...
  protected _prepareUnpackedTextures() {
    this._unpackingTargets = [];
  ...
  protected _unpackTextures() {
    ...
    let planeMaterial = Volume4Material.preprocessMaterial;

    planeMaterial.uniforms.uNumberOfChannels.value = this._material.uniforms.uNumberOfChannels.value;
    planeMaterial.uniforms.uBitsAllocated.value = this._material.uniforms.uBitsAllocated.value;
    planeMaterial.uniforms.uPixelType.value = this._material.uniforms.uPixelType.value;
    planeMaterial.uniforms.uPackedPerPixel.value = this._material.uniforms.uPackedPerPixel.value;
    ...
    preProcessScene.remove(planeMesh);
    planeMesh = null;
    planeGeom.dispose();
    planeMaterial.dispose();
    preProcessScene = null;
    preProcessRenderer = null;
